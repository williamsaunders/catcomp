...
data = np.genfromtxt('zone29-coadd_detection_results.csv', delimiter=',', dtype=None)
data = np.array(data)
...
plt.title('Comparison of Depth of Bands in Zone 29')
plt.ylabel('M50')
plt.xlabel('band')
plt.grid()
plt.savefig('zone29/band_efficiency.png')
plt.show()
